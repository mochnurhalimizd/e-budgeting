	        ...
	        <div class="col-xs-12">
	          <div class="box box-warning">
	            <div class="box-header">
	            	<div class="row">
	            		<div class="col-sm-6">
	            			<h3 class="box-title">Daftar PNS DISBUDPAR</h3>
	            		</div>

	            		<div class="col-sm-6">
	            		<div class=" pull-right">
	            			<a class="btn btn-app" href="?page=disbudpar_view_anggaran">
	           ...
	           <div class="box-body" style="overflow-x: scroll;">
				...
				$result = mysqli_query($con,"SELECT * FROM pegawai WHERE kd_rek_skpd LIKE '%DISBUDPAR'");
