	        ...
	        <div class="col-xs-12">
	          <div class="box box-warning">
	            <div class="box-header">
	            	<div class="row">
	            		<div class="col-sm-6">
	            			<h3 class="box-title">Daftar PNS BPKD</h3>
	            		</div>
	            		...
	            		<div class=" pull-right">
						    ...
						    <a class="btn btn-app" href="?page=bpkd_view_anggaran">
				...
				$result = mysqli_query($con,"SELECT * FROM pegawai WHERE kd_rek_skpd LIKE '%BPKD'");
