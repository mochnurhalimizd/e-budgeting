...
<section class="content-header">
  <h1>
    Laporan Anggaran DISDUKCAPIL
    <small>Dinas Kependudkan dan Catatan Sipil</small>
  </h1>
  <ol class="breadcrumb">
	      ...
	      <div class="row">
	        <div class="col-xs-12">
	          <div class="box box-warning">
				...
				$result = mysqli_query($con, "SELECT gapok  FROM dtl_gapok_skpd where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'IV'");
				while($row = mysqli_fetch_array($result))
				{	
					$angka =  $row[0];	  
				}
				$result2 = mysqli_query($con, "SELECT gapok  FROM dtl_gapok_skpd where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'III'");
				while($row2 = mysqli_fetch_array($result2))
				{	
					$angka2 =  $row2[0]; 
				}
				$result3 = mysqli_query($con, "SELECT gapok  FROM dtl_gapok_skpd where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'II'");
				...
				$hasil = mysqli_query($con, "SELECT * FROM pegawai where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'IV'");
				$row = mysqli_num_rows($hasil);
				
				$hasil2 = mysqli_query($con, "SELECT * FROM pegawai where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'III'");
				$row2 = mysqli_num_rows($hasil2);
				
				$hasil3 = mysqli_query($con, "SELECT * FROM pegawai where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'II'");
				...
				$jumlah4=0;
				$result4 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'IV'");
				while($row4 = mysqli_fetch_array($result4))
				{	
					$jumlah4 = $jumlah4 + $row4[0];
				}
				$result5 = mysqli_query($con, "SELECT harga_satuan FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'IV' AND kd_rek_tunjangan LIKE '5.1.1.01.02'");
				while($row5 = mysqli_fetch_array($result5))
				{	
					$angka4 =  $row5[0];	  
				}
				$hasil5 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'IV'");
				...
				$jumlah5=0;
				$result6 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'III'");
				while($row6 = mysqli_fetch_array($result6))
				{	
					$jumlah5 = $jumlah5 + $row6[0];
				}
				$result7 = mysqli_query($con, "SELECT harga_satuan FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'III' AND kd_rek_tunjangan LIKE '5.1.1.01.02'");
				while($row7 = mysqli_fetch_array($result7))
				{	
					$angka6 =  $row7[0];	  
				}
				$hasil6 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'III'");
				...
				$jumlah6=0;
				$result8 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'II'");
				while($row8 = mysqli_fetch_array($result8))
				{	
					$jumlah6 = $jumlah6 + $row8[0];
				}
				$result9 = mysqli_query($con, "SELECT harga_satuan FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'II' AND kd_rek_tunjangan LIKE '5.1.1.01.02'");
				while($row9 = mysqli_fetch_array($result9))
				{	
					$angka8 =  $row9[0];	  
				}
				$hasil7 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'II'");
				...
				$result10 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_eselon LIKE 'II/b'");
				while($row10 = mysqli_fetch_array($result10))
				{	
					$angka10 =  $row10[0];	  
				}
				$result12 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_eselon LIKE 'III/a'");
				while($row12 = mysqli_fetch_array($result12))
				{	
					$angka12 =  $row12[0]; 
				}
				$result13 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_eselon LIKE 'III/b'");
				while($row13 = mysqli_fetch_array($result13))
				{	
					$angka13 =  $row13[0];	  
				}
				$result14 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_eselon LIKE 'IV/a'");
				...
				$hasil11 = mysqli_query($con, "SELECT * FROM pegawai WHERE kd_rek_skpd LIKE 'DISDUKCAPIL' AND kd_golongan LIKE 'IV' AND eselon LIKE 'II/b'");
				$row11 = mysqli_num_rows($hasil11);
				
				$hasil12 = mysqli_query($con, "SELECT * FROM pegawai WHERE kd_rek_skpd LIKE 'DISDUKCAPIL' AND kd_golongan LIKE 'III' AND eselon LIKE 'III/a'");
				$row12 = mysqli_num_rows($hasil12);
				
				$hasil13 = mysqli_query($con, "SELECT * FROM pegawai WHERE kd_rek_skpd LIKE 'DISDUKCAPIL' AND kd_golongan LIKE 'III' AND eselon LIKE 'III/b'");
				$row13 = mysqli_num_rows($hasil13);
				
				$hasil14 = mysqli_query($con, "SELECT * FROM pegawai WHERE kd_rek_skpd LIKE 'DISDUKCAPIL' AND kd_golongan LIKE 'II' AND eselon LIKE 'IV/a'");
				...
				$result16 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'III' AND kd_rek_tunjangan like '5.1.1.01.05'");
				while($row16 = mysqli_fetch_array($result16))
				{	
					$angka16 =  $row16[0]; 
				}
				$result17 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'II' AND kd_rek_tunjangan like '5.1.1.01.05'");
				...
				$hasil16 = mysqli_query($con, "SELECT * FROM pegawai WHERE kd_rek_skpd LIKE 'DISDUKCAPIL' AND kd_golongan LIKE 'III' AND eselon LIKE 'V'");
				$row16 = mysqli_num_rows($hasil16);
				
				$hasil17 = mysqli_query($con, "SELECT * FROM pegawai WHERE kd_rek_skpd LIKE 'DISDUKCAPIL' AND kd_golongan LIKE 'II'");
				...
				$jumlah20=0;
				$result20 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'IV'");
				while($row20 = mysqli_fetch_array($result20))
				{	
					$jumlah20 = $jumlah20 + $row20[0];
				}
				$result21 = mysqli_query($con, "SELECT harga_satuan FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'IV' AND kd_rek_tunjangan LIKE '5.1.1.01.06'");
				while($row21 = mysqli_fetch_array($result21))
				{	
					$angka21 =  $row21[0];	  
				}
				$hasil22 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'IV'");
				...
				$jumlah25=0;
				$result25 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'III'");
				while($row25 = mysqli_fetch_array($result25))
				{	
					$jumlah25 = $jumlah25 + $row25[0];
				}
				$result26 = mysqli_query($con, "SELECT harga_satuan FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'III' AND kd_rek_tunjangan LIKE '5.1.1.01.06'");
				while($row26 = mysqli_fetch_array($result26))
				{	
					$angka26 =  $row26[0];	  
				}
				$hasil27 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'III'");
				...
				$jumlah30=0;
				$result30 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'II'");
				while($row30 = mysqli_fetch_array($result30))
				{	
					$jumlah30 = $jumlah30 + $row30[0];
				}
				$result31 = mysqli_query($con, "SELECT harga_satuan FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'II' AND kd_rek_tunjangan LIKE '5.1.1.01.06'");
				while($row31 = mysqli_fetch_array($result31))
				{	
					$angka31 =  $row31[0];	  
				}
				$hasil32 = mysqli_query($con, "SELECT jml_anak FROM pegawai WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND status_perkawinan LIKE 'kawin' AND kd_golongan LIKE 'II'");
				...
				//-----Start PPh --->
				$result40 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'IV' AND kd_rek_tunjangan like '5.1.1.01.07'");
				while($row40 = mysqli_fetch_array($result40))
				{	
					$angka40 =  $row40[0];	  
				}
				$result41 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'III' AND kd_rek_tunjangan like '5.1.1.01.07'");
				...
				$hasil43 = mysqli_query($con, "SELECT * FROM pegawai where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'IV'");
				$row43 = mysqli_num_rows($hasil43);
				
				$hasil44 = mysqli_query($con, "SELECT * FROM pegawai where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'III'");
				...
				$result50 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'IV' AND kd_rek_tunjangan like '5.1.1.01.08'");
				while($row50 = mysqli_fetch_array($result50))
				{	
					$angka50 =  $row50[0];	  
				}
				$result51 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'III' AND kd_rek_tunjangan like '5.1.1.01.08'");
				while($row51 = mysqli_fetch_array($result51))
				{	
					$angka51 =  $row51[0]; 
				}
				$result52 = mysqli_query($con, "SELECT harga_satuan  FROM dtl_tunjangan_golongan WHERE kd_rek_skpd LIKE '%DISDUKCAPIL' AND kd_golongan LIKE 'II' AND kd_rek_tunjangan like '5.1.1.01.08'");
				...
				$hasil53 = mysqli_query($con, "SELECT * FROM pegawai where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'IV'");
				$row53 = mysqli_num_rows($hasil53);
				
				$hasil54 = mysqli_query($con, "SELECT * FROM pegawai where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'III'");
				$row54 = mysqli_num_rows($hasil54);
				
				$hasil55 = mysqli_query($con, "SELECT * FROM pegawai where kd_rek_skpd like '%DISDUKCAPIL' AND kd_golongan LIKE 'II'");
