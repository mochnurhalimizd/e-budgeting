...
<section class="content-header">
  <h1>
    ADD Data
    <small>Dinas Koperasi Usaha Kecil dan Menengah <b>(DISKOPUKM)</b></small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-institution"></i> Level</a></li>
    <li class="active"><a href="?page=skpd">SKPD</a></li>
    <li class="active"><a href="?page=diskopukm_view_pegawai">DISKOPUKM</a></li>
...
<!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Form PNS Baru</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="jml_anak" placeholder="Jumlah Anak">
                  </div>
                </div>
              ...
              <div class="box-footer">
              	<a href="?page=diskopukm_view_pegawai">
