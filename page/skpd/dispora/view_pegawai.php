	        ...
	        <div class="col-xs-12">
	          <div class="box box-warning">
	            <div class="box-header">
	            	<div class="row">
	            		<div class="col-sm-6">
	            			<h3 class="box-title">Daftar PNS DISPORA</h3>
	            		</div>

	            		<div class="col-sm-6">
	            		<div class=" pull-right">
	            			<a class="btn btn-app" href="?page=dispora_view_anggaran">
								<i class="fa fa-plus"></i> Laporan Anggaran
						    </a>
	            			<!-- <a class="btn btn-app" href="?page=bpkd_add">
				...
				$result = mysqli_query($con,"SELECT * FROM pegawai WHERE kd_rek_skpd LIKE 'DISPORA'");
