...
<section class="content-header">
  <h1>
    DPMPTSP
    <small>Dinas Penanaman Modal dan Pelayanan Terpadu Satu PIntu</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-institution"></i> Level</a></li>
    <li class="active"><a href="?page=skpd">SKPD</a></li>
    <li class="active">DPMPTSP</li>
  </ol>
</section>
	        ...
	        <div class="col-xs-12">
	          <div class="box box-warning">
	            <div class="box-header">
	            	<div class="row">
	            		<div class="col-sm-6">
	            			<h3 class="box-title">Daftar PNS DPMPTSP</h3>
	            		</div>

	            		<div class="col-sm-6">
	            		<div class=" pull-right">
	            			<a class="btn btn-app" href="?page=lh_view_anggaran">
								<i class="fa fa-plus"></i> Laporan Anggaran
						    </a>
	            			<!-- <a class="btn btn-app" href="?page=lh_add">
	           ...
	           <!-- /.box-header -->
	            <div class="box-body" style="overflow-x: scroll;">
	               <table id="bpkd-table" class="table table-bordered table-hover" style="width: 120%;">
	                <thead>
	                <tr>
	                  <th>NIP</th>
	                  <th>Nama</th>
				...
				$result = mysqli_query($con,"SELECT * FROM pegawai WHERE kd_rek_skpd LIKE 'DPMPTSP'");
