...
<section class="content-header">
  <h1>
    Table Master Gaji Pokok SKPD
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-institution"></i> Level</a></li>
    <li class="active">Table Master Gaji Pokok SKPD</li>
  </ol>
</section>
	          ...
	          <div class="box box-warning">
	            <div class="box-header">
	            	<div class="row">
	            		...
	            		<div class=" pull-right">
	            			<a class="btn btn-app" href="?page=form_master_gapok_skpd">
	            ...
	            <div class="box-body">
	              <table id="bpkd-table" class="table table-bordered table-hover">
	                ...
	                <tbody>
	            	<?php  
						$result = mysqli_query($con,"SELECT * FROM dtl_gapok_skpd");
