	        ...
	        <div class="col-xs-12">
	          <div class="box box-warning">
	            <div class="box-header">
	            	<div class="row">
	            		...
	            		<div class=" pull-right">
	            			<a class="btn btn-app" href="?page=form_master_pegawai">
				...
				<tr class='default'>
					...
					<td> 
            <a href="?page=edit_master_pegawai&&nip=<?php echo $row['nip']; ?>">
	           <button type='button' data-toggle='modal' class='btn btn-warning btn-flat' style='padding:0;padding:2px 4px;'><i class='fa fa-edit'></i></button>
	          </a> 
