...
<section class="content-header">
  <h1>
    Table Master Detail Tunjangan
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-institution"></i> Level</a></li>
    <li class="active">Table Master Detail Tunjangan</li>
  </ol>
</section>
	        ...
	        <div class="col-xs-12">
	          <div class="box box-warning">
	            <div class="box-header">
	            	<div class="row">
	            		<div class="col-sm-6">
	            			<h3 class="box-title">Daftar Detail Tunjangan </h3>
	            		</div>

	            		<div class="col-sm-6">
	            		<div class=" pull-right">
	            			<a class="btn btn-app" href="?page=form_master_dtl_tunjangan">
	            ...
	            <div class="box-body">
	              <table id="bpkd-table" class="table table-bordered table-hover">
	                ...
	                <tbody>
	            	<?php  
						$result = mysqli_query($con,"SELECT * FROM dtl_tunjangan_golongan");
               ...
               <!-- form start -->
	            <form class="form-horizontal">
	              <div class="box-body">
	                ...
	                <div class="form-group">
	                  <label for="kd_rek_kecamatan" class="col-sm-2 control-label">Kode Rekening Kecamatan</label>
	                  <div class="col-sm-10">                   
	                    <select class="form-control">
	                      <option>4.04.05.01</option>
	                      <option>4.04.05.02</option>
	                ...
	                <div class="form-group">
	                  <label for="kd_rek_tunjangan" class="col-sm-2 control-label">Kode Rekening Tunjangan</label>
	                  <div class="col-sm-10">                   
	                    <select class="form-control">
	                      <option>4.04.05.01</option>
	                      <option>4.04.05.02</option>
