	        ...
	        <div class="col-xs-12">
	          <div class="box box-warning">
	            <div class="box-header">
	            	<div class="row">
	            		<div class="col-sm-6">
	            			<h3 class="box-title">Daftar PNS Kec.Parongpong</h3>
	            		</div>

	            		<div class="col-sm-6">
	            		<div class=" pull-right">
	            			<a class="btn btn-app" href="?page=parongpong_view_anggaran">
				...
				$result = mysqli_query($con,"SELECT * FROM pegawai WHERE kd_rek_kecamatan LIKE '%parongpong'");
